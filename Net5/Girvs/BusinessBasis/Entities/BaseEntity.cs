...
namespace Girvs.BusinessBasis.Entities
{
    ...
    public abstract class BaseEntity<TPrimaryKey> : Entity
    {
        ...
        private void FormatPrpertyValue()
        {
            ...
            // {
            //     var creatorName = EngineContext.Current.GetCurrentClaimByName(config.ClaimName)?.Value;
            ...
            // {
            //     var tenantIdStr = EngineContext.Current.GetCurrentClaimByName(config.ClaimTenantId)?.Value;
            //
            ...
            // {
            //     var userIdStr = EngineContext.Current.GetCurrentClaimByName(config.ClaimSid)?.Value;
            //
