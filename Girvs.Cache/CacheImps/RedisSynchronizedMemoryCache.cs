...
public partial class RedisSynchronizedMemoryCache : ISynchronizedMemoryCache
{
    ...
    public RedisSynchronizedMemoryCache(
    ...
    )
    {
        ...
        var publishIntervalMs = appSettings
            .Get<CacheConfig>()
            .DistributedCacheConfig.PublishIntervalMs;
    ...
    protected string ChannelPrefix =>
        $"__change@{_connection.GetDatabase().Database}__{_connection.Instance}__:";
    ...
    protected void BatchPublishChangeEvents(params string[] keys)
    {
        ...
        var subscriber = _connection.GetSubscriber();
        subscriber.Publish(
            RedisChannel.Pattern($"{ChannelPrefix}{_processId}"),
