...
public abstract partial class CacheKeyService : ICacheKeyService
{
    ...
    protected virtual string CreateIdsHash(params object[] ids)
    {
    ...
    protected virtual object CreateCacheKeyParameters(object parameter)
    {
        ...
        {
            null => "null",
            IEnumerable<Guid> ids => CreateIdsHash(ids.ToArray()),
            IEnumerable<BaseEntity> entities
                => CreateIdsHash(entities.Select(entity => (object)entity.Id).ToArray()),
