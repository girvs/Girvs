...
namespace Girvs.Domain
{
    ...
    public partial class CommonHelper
    {
        ...
        /// <returns>如果字符串是有效的IpAddress，则返回true；否则，返回false</returns>
        ...
        /// <returns>输入字符串，如果长度可以；否则，输入字符串将被截断</returns>
        ...
        /// </summary>
        /// <param name="str">Input string</param>
        /// <returns>输入字符串仅包含数字值，如果输入为null / empty，则为空字符串</returns>
