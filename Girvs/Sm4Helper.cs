...
public static class Sm4Helper
{
    ...
    /// <returns></returns>
    public static string Sm4Encrypt_ECB(
        this string plainText,
        string secretKey,
        bool secretKeyHexString = true
    )
    {
        ...
        var ctx = new Sm4Context { isPadding = true, mode = Sm4Crypto.SM4_ENCRYPT };
    ...
    /// <param name="secretKeyHexString">是否为十六进制</param>
    /// <returns></returns>
    public static string Sm4Decrypt_ECB(
    ...
    )
    {
        ...
        var ctx = new Sm4Context { isPadding = true, mode = Sm4Crypto.SM4_DECRYPT };
