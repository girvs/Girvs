...
{
    public override string OutputFileName { get; } = "{EntityName}\\{EntityName}UpdateViewModel.cs";
    public override string GeneratorName { get; } = "UpdateViewModel";
    public override string TemplateResourceName { get; } =
        "Girvs.CodeGenerator.CodeTemplates.Application.ViewModels.UpdateViewModel.tt";
}
