...
public class GirvsCSharpMigrationOperationGenerator(
    ...
    )
    {
        ...
        using (builder.Indent())
        {
            ...
            builder
                ...
                .Append($"GetShardingTableName<{operation.PrincipalTable}>()")
                .AppendLine(",");
                ...
                foreach (var foreignKey in operation.ForeignKeys)
                {
                    ...
                    using (builder.Indent())
                    {
                        ...
                        builder
                            .AppendLine(",")
                            .Append("principalTable: ")
                            .Append($"GetShardingTableName<{foreignKey.PrincipalTable}>()")
                            .AppendLine(",");
        ...
        using (builder.Indent())
        {
            ...
            if (operation.NewName != null)
            {
                builder
                    .AppendLine(",")
                    .Append("newName: ")
                    .Append($"GetShardingTableName<{operation.NewName}>()");
            }
