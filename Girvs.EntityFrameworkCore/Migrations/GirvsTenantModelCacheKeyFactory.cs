    ...
    where TContext : DbContext
{
    ...
    public GirvsTenantModelCacheKeyFactory(ModelCacheKeyFactoryDependencies dependencies)
        : base(dependencies) { }
}
    ...
    where TContext : DbContext
{
    ...
    public TenantModelCacheKey(TContext context, string identifier, bool designTime)
