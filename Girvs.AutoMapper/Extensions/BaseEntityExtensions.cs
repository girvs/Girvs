...
{
    public static TDto MapToDto<TDto>(this Entity entity)
        where TDto : IDto, new()
    {
    ...
    public static TEntity MergeForm<TEntity>(this Entity entity, TEntity source)
    ...
    public static TEntity MergeForm<TEntity>(
        this Entity entity,
        TEntity source,
        string[] specifyPropertyNames
    )
        where TEntity : Entity, new()
    {
